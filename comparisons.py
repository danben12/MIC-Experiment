...
def dashborde():
    ...
    for key, value in initial_data.items():
        ...
        droplet_histogram_column.children[0].x_range = Range1d(start=10 ** 3, end=10 ** 8)
        ...
        N0_Vs_Volume_column = N0_Vs_Volume(value)
        N0_Vs_Volume_column.children[0].update(title=f'N0 Vs Volume for {key}')
        N0_Vs_Volume_column.children[0].x_range = Range1d(start=10 ** 3, end=10 ** 8)
        ...
        Initial_Density_Vs_Volume_column.x_range = Range1d(start=10 ** 3, end=10 ** 8)
        ...
        growth_curves_column.children[0].x_range = Range1d(start=0, end=24)
        growth_curves_column.children[0].y_range = Range1d(start=0, end=10**7)
        growth_curves_column.children[1].x_range = Range1d(start=0, end=24)
        ...
        normalize_growth_curves_column.children[0].x_range = Range1d(start=0, end=24)
        normalize_growth_curves_column.children[0].y_range = Range1d(start=0, end=1.3)
        normalize_growth_curves_column.children[1].x_range = Range1d(start=0, end=24)
        ...
        fold_change_column = fold_change(chip)
        fold_change_column.update(title=f'Fold Change for {key}')
        fold_change_column.x_range = Range1d(start=10**3, end=10**8)
        ...
        last_4_hours_average_column.x_range = Range1d(start=10**3, end=10**8)
        last_4_hours_average_column.y_range = Range1d(start=0.1, end=10**6)
        plot_types['last_4_hours_average'].append(last_4_hours_average_column)
        death_rate_by_droplets_column = death_rate_by_droplets(chip)
        death_rate_by_droplets_column.update(title=f'Death Rate by Droplet Size for {key}')
        death_rate_by_droplets_column.x_range = Range1d(start=3, end=8)
        death_rate_by_droplets_column.y_range = Range1d(start=-1.2, end=0.4)
        ...
        death_rate_by_bins_column.x_range = Range1d(start=0, end=24)
        death_rate_by_bins_column.y_range = Range1d(start=-2.5, end=1.2)
        death_rate_by_bins_column.update(title=f'Death Rate by Bin for {key}')
        ...
        distance_Vs_Volume_colored_by_death_rate_column.children[1].update(title=f'Distance to Center vs. Volume Colored by Death Rate for {key}')
        ...
        bins_volume_Vs_distance_column = main.bins_volume_Vs_distance(chip)
